...
export default function NotFound() {
  return (
    <div className="h-screen w-full bg-gradient-to-b from-[#CBE4F9] to-[#E3F2FC] relative overflow-hidden font-sans flex flex-col justify-center items-center m-0 p-0">
      {/* Noise Overlay */}
